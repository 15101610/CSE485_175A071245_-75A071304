...
<body>
	<div class="logform">
		<h1>Quên mật khẩu</h1>
<form name="login" method="post" action="process-forget-pass.php">

<p>Tên đăng nhập:</p><input class="username" type="text"  placeholder="" name="username"> <br>
<p>Email:</p><input class="email" type="email" placeholder="" name="email"><br>

<input id="" class="submit" type="submit" name="submit" value="Quên mật khẩu">
